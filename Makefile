...
# ***** Kayla Marie Verdeflor *****
################################################################################

# TA-TODO: Jellyfishing.
# This should be a just a name i.e MyFirstGBAProgram
# No SPACES AFTER THE NAME.
PROGNAME = Jellyfishing
...
# OFILES = gba.o font.o main.o images/start_bg.o images/end_bg.o
...
.PHONY: debug
debug: CFLAGS += $(CRELEASE) -I../shared
debug: LDFLAGS += $(CRELEASE)
debug: $(PROGNAME).gba
	@echo "[FINISH] Created $(PROGNAME).gba"
